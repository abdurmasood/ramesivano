                  ...
                  <div className="flex items-center gap-6 justify-center lg:justify-start">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-sm [@media(hover:hover)]:group-hover:text-[#1DB954] transition-colors ${poppins.className}`}>Spotify</span>
                      </div>
                    </a>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-sm [@media(hover:hover)]:group-hover:text-white transition-colors ${poppins.className}`}>Apple Music</span>
                      </div>
                    </a>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-sm [@media(hover:hover)]:group-hover:text-[#FF0000] transition-colors ${poppins.className}`}>YouTube Music</span>
                      </div>
                    </a>
                  </div>
                </div>
