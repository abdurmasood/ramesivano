            ...
            <FadeOnly delay={0.8}>
              ...
              <div className="flex flex-col gap-3">
                <a 
                  ...
                  className="flex items-center justify-center gap-3 p-3 rounded-lg bg-white/5 [@media(hover:hover)]:hover:bg-[#1DB954]/20 text-gray-400 [@media(hover:hover)]:hover:text-[#1DB954] active:bg-[#1DB954]/30 active:text-[#1DB954] transition-all duration-200 active:scale-95 touch-manipulation select-none"
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center justify-center gap-3 p-3 rounded-lg bg-white/5 [@media(hover:hover)]:hover:bg-white/20 text-gray-400 [@media(hover:hover)]:hover:text-white active:bg-white/30 active:text-white transition-all duration-200 active:scale-95 touch-manipulation select-none"
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center justify-center gap-3 p-3 rounded-lg bg-white/5 [@media(hover:hover)]:hover:bg-[#FF0000]/20 text-gray-400 [@media(hover:hover)]:hover:text-[#FF0000] active:bg-[#FF0000]/30 active:text-[#FF0000] transition-all duration-200 active:scale-95 touch-manipulation select-none"
                ...
                <div className="pt-6 text-center lg:text-left">
                  ...
                  <div className="flex items-center gap-6 justify-center lg:justify-start">
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="text-gray-400 [@media(hover:hover)]:hover:text-[#1DB954] active:text-[#1DB954] transition-colors duration-200 group active:scale-95 touch-manipulation select-none"
                      aria-label="Listen on Spotify"
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-sm group-hover:text-[#1DB954] [@media(hover:hover)]:group-hover:text-[#1DB954] transition-colors ${poppins.className}`}>Spotify</span>
                      </div>
                    </a>
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="text-gray-400 [@media(hover:hover)]:hover:text-white active:text-white transition-colors duration-200 group active:scale-95 touch-manipulation select-none"
                      aria-label="Listen on Apple Music"
                    >
                      <div className="flex items-center gap-2">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <span className={`text-sm group-hover:text-white [@media(hover:hover)]:group-hover:text-white transition-colors ${poppins.className}`}>Apple Music</span>
                      </div>
                    </a>
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="text-gray-400 [@media(hover:hover)]:hover:text-[#FF0000] active:text-[#FF0000] transition-colors duration-200 group active:scale-95 touch-manipulation select-none"
                      aria-label="Subscribe on YouTube"
                    >
                      <div className="flex items-center gap-2">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <span className={`text-sm group-hover:text-[#FF0000] [@media(hover:hover)]:group-hover:text-[#FF0000] transition-colors ${poppins.className}`}>YouTube Music</span>
                      </div>
                    </a>
                  </div>
                </div>
