      ...
      <div className={`relative ${playfair.className}`}>
        ...
        <main className="h-[calc(100vh-4rem)]">
          ...
          <div className="relative h-full">
            ...
            <div className="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-black md:from-transparent lg:from-black to-transparent" />
          </div>
        </main>
        
        {/* Black section after the poster with footer */}
        <div className="bg-black md:bg-transparent lg:bg-black">
          <div className="h-12" />
