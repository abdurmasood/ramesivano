          ...
          <div className="flex items-center">
            <div className="hidden lg:flex items-center">
              ...
              <div className="flex items-center space-x-4">
                ...
                <a href="https://twitter.com/ramesivano" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#23b9d6]">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="pt-6 border-t border-white/10">
                  ...
                  <div className="grid grid-cols-5 gap-4">
                    ...
                    <a href="https://twitter.com/ramesivano" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#23b9d6] p-2 rounded-full hover:bg-white/5">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
